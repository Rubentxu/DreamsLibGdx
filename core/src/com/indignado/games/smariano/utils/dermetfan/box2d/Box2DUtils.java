...
public abstract class Box2DUtils {
	...
	/** cached {@link com.badlogic.gdx.physics.box2d.Shape Shapes} and their vertices */
	public static final ObjectMap<Shape, ShapeCache> shapeCache = new ObjectMap<Shape, ShapeCache>(1);

	/** if new {@link com.badlogic.gdx.physics.box2d.Shape} passed in {@link #vertices(com.badlogic.gdx.physics.box2d.Shape)} should be automatically added to the {@link #shapeCache} */
	private static boolean autoShapeCache = true;

	/** the maximum of {@link com.badlogic.gdx.physics.box2d.Shape Shapes} and their vertices to automatically cache if {@link #autoShapeCache} is true */
	private static int autoShapeCacheMaxSize = Integer.MAX_VALUE;

	/** temporary {@link com.badlogic.gdx.math.Vector2} used by some methods
	 ...
	 *  @see #vertices(com.badlogic.gdx.physics.box2d.Shape) */
	...
	/** @see #vertices(com.badlogic.gdx.physics.box2d.Body, com.badlogic.gdx.math.Vector2[]) */
	...
	/** @see #vertices(com.badlogic.gdx.physics.box2d.Fixture, com.badlogic.gdx.math.Vector2[]) */
	...
	/** @see #vertices(com.badlogic.gdx.physics.box2d.Shape, com.badlogic.gdx.math.Vector2[]) */
	...
	/** @see #positionRelative(com.badlogic.gdx.physics.box2d.Shape, float, com.badlogic.gdx.math.Vector2) */
