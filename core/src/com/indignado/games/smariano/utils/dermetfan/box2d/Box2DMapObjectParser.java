...
/**
 * An utility class that parses {@link com.badlogic.gdx.maps.MapObjects} from a {@link com.badlogic.gdx.maps.Map} and generates Box2D {@link com.badlogic.gdx.physics.box2d.Body Bodies}, {@link com.badlogic.gdx.physics.box2d.Fixture Fixtures} and {@link com.badlogic.gdx.physics.box2d.Joint Joints} from it.<br/>
 * Just create a new {@link Box2DMapObjectParser} in any way you like and call {@link #load(com.badlogic.gdx.physics.box2d.World, com.badlogic.gdx.maps.MapLayer)} to load all compatible objects (defined by the {@link Aliases}) into your {@link com.badlogic.gdx.physics.box2d.World}.<br/>
 * <br/>
 * If you only want specific Fixtures or Bodies, you can use the {@link #createBody(com.badlogic.gdx.physics.box2d.World, com.badlogic.gdx.maps.MapObject)} and {@link #createFixture(com.badlogic.gdx.maps.MapObject)} methods.<br/>
 * <br/>
 ...
 * To create {@link com.badlogic.gdx.physics.box2d.Joint Joints}, add any object to the layer and just put everything needed in its properties. Note that you use the editors unit here which will be converted to Box2D meters automatically using {@link Aliases#unitScale}.
 * <p/>
...
public class Box2DMapObjectParser {
    ...
    /**
     * the parsed {@link com.badlogic.gdx.physics.box2d.Body Bodies}
     */
    private ObjectMap<String, Body> bodies = new ObjectMap<String, Body>();

    /**
     * the parsed {@link com.badlogic.gdx.physics.box2d.Fixture Fixtures}
     */
    private ObjectMap<String, Fixture> fixtures = new ObjectMap<String, Fixture>();

    /**
     * the parsed {@link com.badlogic.gdx.physics.box2d.Joint Joints}
     */
