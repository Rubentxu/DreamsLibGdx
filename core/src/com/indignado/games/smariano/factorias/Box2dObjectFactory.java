package com.indignado.games.smariano.factorias;
...
import static com.indignado.games.smariano.modelo.base.Box2DPhysicsObject.GRUPO;

public class Box2dObjectFactory {


    private com.indignado.games.smariano.modelo.World world;
    private World physics;
    private ResourcesManager resourcesManager;
    private float unitScale;

    public Box2dObjectFactory(World physics, com.indignado.games.smariano.modelo.World world, ResourcesManager resourcesManager) {
